...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.2.2-0.20240828060012-2e9b175c0f7f
...
require (
	...
	github.com/smartcontractkit/chainlink-data-streams v0.0.0-20240828064729-61ae62b1e785 // indirect
